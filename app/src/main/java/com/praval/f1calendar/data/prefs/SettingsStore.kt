...
class SettingsStore @Inject constructor(
    ...
    /** Accent palette the whole app is drawn in. */
    val appTheme: Flow<AppTheme> = store.data.map { AppTheme.fromName(it[KEY_APP_THEME]) }
    ...
    suspend fun setAppTheme(theme: AppTheme) = store.edit { it[KEY_APP_THEME] = theme.name }
